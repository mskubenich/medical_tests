...
Gem::Specification.new do |s|
  ...
  s.files = ["Contributors.rdoc", "History.rdoc", "LICENSE", "Manifest.txt", "POSTGRES", "README-OS_X.rdoc", "README-Windows.rdoc", "README.ja.rdoc", "README.rdoc", "ext/extconf.rb", "ext/gvl_wrappers.c", "ext/pg.c", "ext/pg_connection.c", "ext/pg_result.c"]
