class ProfilesController < ApplicationController
  ...
  def ask
    ...
    GameSession.where(profile_id: @profile.id, user_id: current_user.id).destroy_all if params[:reset]
    @game = GameSession.where(profile_id: @profile.id, user_id: current_user.id).first_or_create
    @game.generate_state
